! function(t, i, e, s) {
    ...
    function o(i, e) {
        ...
        t.extend(this, r, e, s), this.calibrationTimer = null, this.calibrationFlag = !0, this.enabled = !1, this.depthsX = [], this.depthsY = [], this.raf = null, this.bounds = null, this.ex = 0, this.ey = 0, this.ew = 0, this.eh = 0, this.ecx = 0, this.ecy = 0, this.erx = 0, this.ery = 0, this.cx = 0, this.cy = 0, this.ix = 0, this.iy = 0, this.mx = 0, this.my = 0, this.vx = 0, this.vy = 0, this.onMouseMove = this.onMouseMove.bind(this), this.onDeviceOrientation = this.onDeviceOrientation.bind(this), this.onOrientationTimer = this.onOrientationTimer.bind(this), this.onCalibrationTimer = this.onCalibrationTimer.bind(this), this.onAnimationFrame = this.onAnimationFrame.bind(this), this.onWindowResize = this.onWindowResize.bind(this), this.initialise()
    }
    var n = "parallax",
        r = {
            relativeInput: !1,
            ...
            case "3D":
                if (o) {
                    var c = e.body || e.createElement("body"),
                        ...
                        m = d.style.overflow,
                        u = !1;
                    e.body || (u = !0, d.style.overflow = "hidden", d.appendChild(c), c.style.overflow = "hidden", c.style.background = ""), c.appendChild(s), s.style[h] = "translate3d(1px,1px,1px)", r = void 0 !== (n = i.getComputedStyle(s).getPropertyValue(a)) && n.length > 0 && "none" !== n, d.style.overflow = m, c.removeChild(s), u && (c.removeAttribute("style"), c.parentNode.removeChild(c))
                }
        }
        return r
    ...
    }, o.prototype.css = function(i, e, s) {
    ...
    t.fn[n] = function(i) {
        ...
        return this.each(function() {
            var s = t(this),
                r = s.data(n);
            r || (r = new o(this, i), s.data(n, r)), a[i] && r[i].apply(r, Array.prototype.slice.call(e, 1))
        })
    }
